...
wikipedia_ceo_xpath="/html/body/div[3]/div[3]/div[5]/div[1]/table[1]/tbody/tr[9]/td/div/ul/li[1]/a[1]"

wikipedia_spacexCEO=driver.find_element("xpath",wikipedia_ceo_xpath).text
...
print("CEO SpaceX menurut Wikipedia",wikipedia_ceo_xpath)
